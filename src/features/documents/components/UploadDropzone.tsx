  ...
  return (
    <div className="space-y-5">
      <label
        ...
        className="group flex cursor-pointer flex-col items-center justify-center rounded-3xl border-2 border-dashed border-blue-200 bg-blue-50/40 px-6 py-12 text-center transition-all hover:border-blue-400 hover:bg-blue-50"
      >
        ...
        <p className="mt-2 max-w-lg text-sm leading-6 text-slate-600">
          Glissez-déposez vos fichiers ou cliquez pour les sélectionner depuis
          votre ordinateur.
        </p>

        <span className="mt-4 rounded-xl border border-blue-200 bg-white px-4 py-2 text-sm font-bold text-blue-700 shadow-sm">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                {files.length} fichier{files.length > 1 ? "s" : ""} dans le
                batch
              </p>
            </div>
